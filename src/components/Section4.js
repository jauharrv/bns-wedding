...
const Section4 = () => {
  return (
    <section className="relative bg-orange-50 -mt-20 px-6 overflow-hidden" id="event">
      <div className="pt-24 bg-orange-50">
        <div className="flex justify-center" data-aos="zoom-in-up">
          <Graphic1 />
        </div>

        <div className="text-sm text-[#a16207] text-center relative z-20" data-aos="zoom-in-up">
          <p className="mt-8">
            Kehadiran serta doa restu Bapak/Ibu/Saudara/i merupakan suatu kebahagiaan dan kehormatan
            bagi kami.
          </p>
          <p className="font-semibold text-yellow-700 mt-2">{`Wassalamu'alaikum Warrahmatullahi Wabarrakatuh`}</p>
        </div>

        <div className="text-center font-semibold text-[#a16207] mt-8 relative z-10">
        ...
        <div className="mt-8 text-center text-yellow-700 relative z-10" data-aos="fade-right">
          <Text className="text-2xl ">Akad Nikah</Text>
          <div className="mt-4 text-lg">
            <p>08.00 WIB</p>
            </div>
        </div>
        <div className="mt-8 text-center text-yellow-700 relative z-10" data-aos="fade-left">
